...
<html lang="en">
  ...
  <!-- MOSTRAR ESPECIALIDADES MEDICO (MODAL) -->
  <div class="modal fade" id="especialidad" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel" >ESPECIALIDADES - HOSPITAL SAN JOSÉ</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <div class="container" id="">
                ...
                <form action="">
                  ...
                  <div class="row">
                    <input type="text"  class="col"  placeholder="Especialidad Médica" required >
  ...
  <!-- FIN--MOSTRAR ESPECIALIDADES MEDICO (MODAL) -->
